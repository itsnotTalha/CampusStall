...
export function ProjectFormStep(
  ...
  if (step === 2) {
    return (
      <div className="space-y-6">
        {/* Free / Paid */}
        <FormField label="Project access">
                  ...
                  <button
                    className={cn(
                      ...
                      selected
                        ...
                        : "border-border/70 bg-background/40 hover:border-primary/30 dark:border-white/10",
                    )}
                    key={option.value}
                    onClick={() => {
                      onValueChange(
                      ...
                      /*
                       * Free projects must always
                       * have price 0.
                       *
                       * Keep Source Only selected
                       * so the existing package
        ...
        {values.accessType ===
          ...
          <div className="rounded-xl border border-primary/20 bg-primary/5 p-4">
            ...
            <p className="mt-1 text-sm leading-6 text-muted-foreground">
              Anyone will be able to get
              this project without making
              a payment after the listing
              is approved.
            </p>
            ...
            <FormField label="Package options">
              <div className="grid gap-3 lg:grid-cols-3">
                {packageOptions.map(
                  (option) => {
                    const selected =
                      values.packageOptions.includes(
                        option.value,
                      );
        ...
        {/* Support duration for free projects */}
        {values.accessType ===
          "free" && (
          <FormField
            hint="Optional support you want to provide after someone gets the project."
          ...
          <select
            ...
            onChange={(event) =>
              onValueChange(
                "licenseType",
                event.target
                  .value as SellerProjectInput["licenseType"],
              )
            }
    ...
    return (
      <div>
        <p className="mb-4 text-sm leading-6 text-muted-foreground">
          Select everything users will
          receive. Only include assets you
          own or can legally distribute.
        </p>
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {includedAssetOptions.map(
            (option) => {
              const selected =
                values.includedAssets.includes(
                  option.value,
                );
    ...
    return (
      <div className="space-y-5">
        <UploadField
          ...
          description={`JPG, PNG, or WebP. Maximum ${
            maxMediaFileSize /
            1024 /
            1024
          } MB.`}
        ...
        <UploadField
          accept="image/jpeg,image/png,image/webp"
          description={`Up to ${maxScreenshotCount} images, ${
            maxMediaFileSize /
            1024 /
            1024
          } MB each.`}
          ...
          multiple
          onChange={
            props.onScreenshotsChange
          }
          selected={
            props.screenshotFiles
              .length > 0
              ? `${
                  props.screenshotFiles
                    .length
  ...
  if (step === 5) {
    return (
      <div className="space-y-6">
        {/* Delivery method */}
        <FormField label="How will users receive this project?">
          <div className="grid gap-3 lg:grid-cols-3">
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                       ...
                       * whenever delivery method changes.
                       */
                      onValueChange(
                        "externalDeliveryUrl",
                        "",
                      ...
                      /*
                       * If moving away from upload,
                       * discard any newly selected
                       * local archive.
                       */
                      if (
                        option.value !==
        ...
        {values.deliveryMethod ===
          ...
          <>
            <div className="flex gap-3 rounded-xl border border-amber-500/20 bg-amber-500/8 p-4 text-sm leading-6">
              ...
              <p>
                Project archives are
                stored privately. They
            ...
            <UploadField
              ...
              description={`ZIP, TAR, GZ, or 7Z. Maximum ${
                maxArchiveFileSize /
                1024 /
                1024
              } MB.`}
        ...
        {values.deliveryMethod ===
          ...
          <div className="space-y-4">
            <div className="rounded-xl border border-border/70 bg-muted/30 p-4 text-sm leading-6 text-muted-foreground">
              Add the GitHub repository
              that contains the project.
              For a free project, make
              sure users can access the
              repository.
            </div>

            <FormField
              hint="Example: https://github.com/username/project"
        ...
        {values.deliveryMethod ===
          ...
          <div className="space-y-4">
            <div className="rounded-xl border border-border/70 bg-muted/30 p-4 text-sm leading-6 text-muted-foreground">
              Add a Google Drive file or
              folder link. Make sure the
              sharing settings allow the
              intended users to open it.
            </div>

            <FormField
              hint='For free projects, use "Anyone with the link" sharing.'
